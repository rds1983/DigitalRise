...
namespace Samples
{
	...
	public class DeferredGraphicsOptionsObject : GameObject
	{
		...
		protected override void OnLoad()
		{
			...
			var depthScaleSlider = (Widget)SampleHelper.AddSlider(
			  shadowMaskPanel,
			  "Blur depth scaling",
			  "F2",
			  0.0f,
			...
			depthScaleSlider.Enabled = blurCheckBox.IsChecked && (bilateralCheckBox.IsChecked || anisotropicCheckBox.IsChecked);
			EventHandler setDepthScaleSliderIsEnabledHandler = (s, e) =>
			{
				depthScaleSlider.Enabled = blurCheckBox.IsChecked
			...
			var upsampleDepthSensitivitySlider = (Widget)SampleHelper.AddSlider(
			  shadowMaskPanel,
			...
			upsampleDepthSensitivitySlider.Enabled = halfResCheckBox.IsChecked;
