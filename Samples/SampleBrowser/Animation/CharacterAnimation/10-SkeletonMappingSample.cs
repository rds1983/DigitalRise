...
Dude skeleton (left) to the Marine skeleton (right).",
  ...
  public class SkeletonMappingSample : CharacterAnimationSample
  {
      ...
      : base(game)
    {
      ...
      _dudeMeshNode.PoseLocal = new Pose(new Vector3(-0.5f, 0, 0), Matrix33F.CreateRotationY(ConstantsF.Pi));
      ...
      _marineMeshNode.PoseLocal = new Pose(new Vector3(0.5f, 0, 0), Matrix33F.CreateRotationY(ConstantsF.Pi));
