/* Generated by MyraPad at 10/27/2023 2:51:21 PM */
using Myra;
...
namespace DigitalRise.LevelEditor.UI
{
	partial class MainForm: VerticalStackPanel
	{
		private void BuildUI()
		{
			...
			toggleButton1.HorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			toggleButton1.VerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			...
			var toggleButton2 = new ToggleButton();
			toggleButton2.HorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			toggleButton2.VerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			Grid.SetColumn(toggleButton2, 1);
			toggleButton2.Content = label2;
			...
			StackPanel.SetProportionType(_gridTerrainLibrary, Myra.Graphics2D.UI.ProportionType.Fill);
			_gridTerrainLibrary.Widgets.Add(toggleButton1);
			_gridTerrainLibrary.Widgets.Add(toggleButton2);
			...
			_sliderTerrainPower.Value = 0.17886178f;
