...
namespace DigitalRise.Animation.Character
{
  ...
  /// very similar to the <see cref="DigitalRise.Geometry.Pose"/> type, but it adds a scale factor.
  /// </para>
  /// <para>
  ...
  public struct SrtTransform : IEquatable<SrtTransform>
  {
    ...
    /// </para>
    /// <para>
    /// This method is available only in the XNA-compatible build of the DigitalRise.Animation.dll.
    /// </para>
    /// </remarks>
