...
namespace DigitalRise.Animation
{
  ...
  /// clip. The default loop behavior is <see cref="DigitalRise.Animation.LoopBehavior.Constant"/> 
  /// which means that the last value of the animation clip is returned for the rest of the 
  /// duration. The loop behavior <see cref="DigitalRise.Animation.LoopBehavior.Cycle"/> causes the 
  /// animation clip to be repeated from the start. The loop behavior 
  /// <see cref="DigitalRise.Animation.LoopBehavior.CycleOffset"/> is similar to 
  /// <see cref="DigitalRise.Animation.LoopBehavior.Cycle"/> except that it also applies an offset
  /// to the animation values in each new iteration. The loop behavior 
  /// <see cref="DigitalRise.Animation.LoopBehavior.Oscillate"/> (also known as 'auto-reverse' or
  ...
  public class AnimationClip<T> : IAnimation<T>
  {
    ...
    /// The default value is <see cref="DigitalRise.Animation.FillBehavior.Hold"/>.
    /// </value>
    ...
    /// <see cref="DigitalRise.Animation.LoopBehavior.Constant"/>.
    /// </value>
