...
using DigitalRise.Mathematics.Algebra.Design;
...
namespace DigitalRise.Mathematics.Algebra
{
  ...
  public struct Vector4D : IEquatable<Vector4D>
  {
    ...
    /// </summary>
    /// <param name="vector">The DigitalRise <see cref="Vector4D"/>.</param>
    ...
    /// <returns>The <see cref="Vector4D"/> (DigitalRise Mathematics).</returns>
    /// <remarks>
    ...
    /// <summary>
    /// Converts this <see cref="Vector4D"/> (DigitalRise Mathematics) to <see cref="Vector4"/> 
    /// (XNA Framework).
    /// </summary>
    /// <param name="vector">The <see cref="Vector4"/> (XNA Framework).</param>
    /// <returns>The <see cref="Vector4D"/> (DigitalRise Mathematics).</returns>
    ...
    /// <summary>
    /// Performs an conversion from <see cref="Vector4D"/> (DigitalRise Mathematics) to 
    /// <see cref="Vector4"/> (XNA Framework).
    /// </summary>
    /// <param name="vector">The <see cref="Vector4D"/> (DigitalRise Mathematics).</param>
