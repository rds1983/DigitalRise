...
namespace DigitalRise.Mathematics.Algebra
{
  ...
  public struct Vector4F : IEquatable<Vector4F>
  {
    ...
    /// <returns>The <see cref="Vector4F"/> (DigitalRise Mathematics).</returns>
    /// <remarks>
    ...
    /// <summary>
    /// Converts this <see cref="Vector4F"/> (DigitalRise Mathematics) to <see cref="Vector4"/> 
    /// (XNA Framework).
    /// </summary>
    /// <param name="vector">The <see cref="Vector4"/> (XNA Framework).</param>
    /// <returns>The <see cref="Vector4F"/> (DigitalRise Mathematics).</returns>
    ...
    /// <summary>
    /// Performs an conversion from <see cref="Vector4F"/> (DigitalRise Mathematics) to 
    /// <see cref="Vector4"/> (XNA Framework).
    /// </summary>
    /// <param name="vector">The <see cref="Vector4F"/> (DigitalRise Mathematics).</param>
