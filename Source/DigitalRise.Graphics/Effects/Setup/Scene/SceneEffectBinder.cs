...
namespace DigitalRise.Graphics.Effects
{
	...
	public class SceneEffectBinder : DictionaryEffectBinder
	{
		...
		public SceneEffectBinder()
		{
			...
			/* Obsolete */
			d.Add(SceneEffectParameterSemantics.DirectionalLightShadowFilterRadius, (e, p, o) => CreateDelegateParameterBinding<Vector4>(e, p, GetDirectionalLightShadowFilterRadius));
			/* Obsolete */
			d.Add(SceneEffectParameterSemantics.DirectionalLightShadowJitterResolution, (e, p, o) => CreateDelegateParameterBinding<Vector4>(e, p, GetDirectionalLightShadowJitterResolution));
