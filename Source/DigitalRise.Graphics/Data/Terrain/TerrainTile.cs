...
namespace DigitalRise.Graphics
{
  ...
  /// <see cref="Graphics.Terrain.Invalidate(DigitalRise.Geometry.Shapes.Aabb)"/> or
        ...
        {
          {
            ...
            new EffectBinding(
              graphicsService,
              graphicsService.GetStockEffect("DigitalRise/Terrain/TerrainGeometryLayer"),
              null,
          ...
          },
          {
            ...
            new EffectBinding(
              graphicsService,
              graphicsService.GetStockEffect("DigitalRise/Terrain/TerrainHoleLayer"),
              null,
              EffectParameterHint.Material)
          }
        };
