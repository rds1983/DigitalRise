...
namespace DigitalRise.Graphics.PostProcessing
{
  ...
  public class SmaaFilter : PostProcessor
  {
      ...
      : base(graphicsService)
    {
      ...
      _effect = GraphicsService.GetStockEffect("DigitalRise/PostProcessing/SmaaFilter");
...
/*      _areaLookupTexture = content.Load<Texture2D>("DigitalRise/PostProcessing/SmaaAreaTexDX9");
      _searchLookupTexture = content.Load<Texture2D>("DigitalRise/PostProcessing/SmaaSearchTex");*/
    }
    #endregion
