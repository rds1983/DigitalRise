...
namespace DigitalRise.Graphics.SceneGraph
{
  ...
  /// the transform in the instance data. Currently, the  predefined material effects of DigitalRise
  ...
  public class MeshInstancingNode<T> : MeshNode, IMeshInstancingNode where T : struct, IVertexType
  {
    ...
    /// </value>
    /// <remarks>
    /// The default bounding shape is <see cref="DigitalRise.Geometry.Shapes.Shape.Infinite"/>,
