...
namespace DigitalRise.Graphics
{
  ...
  /// </para>
  /// <para>
  /// <sup>1</sup> If the world matrix is stored in a <see cref="Matrix44F"/> (DigitalRise data
  ...
  /// matrix. World matrices in DigitalRise Mathematics and XNA are transposed (see documentation of
  /// DigitalRise Mathematics).
  /// </para>
  /// <para>
  /// The above paragraphs describe how the <see cref="MeshRenderer"/> and the default DigitalRise
