	...
	internal static class Resources
	{
		...
		public static Texture2D White
		{
			get
			{
				if (_white == null)
				{
					_white = new Texture2D(DR.GraphicsDevice, 1, 1);
		...
		public static Texture2D WaterNormals1
		{
			get
			{
				...
				{
					_waterNormals1 = _assetManager.LoadTexture2D(DR.GraphicsDevice, "Images.waterNormals1.png");
				}
		...
		public static Texture2D WaterNormals2
		{
			get
			{
				if (_waterNormals2 == null)
				{
					...
					{
						_waterNormals2 = Texture2D.FromStream(DR.GraphicsDevice, stream);
					}
				}
