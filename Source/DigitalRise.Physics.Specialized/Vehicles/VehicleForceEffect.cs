  ...
  internal class VehicleForceEffect : ForceEffect
  {
    ...
    protected override void OnApply()
    {
      ...
      for (int i = 0; i < numberOfWheels; i++)
      {
        ...
        // ----- Ground tangents
        Vector3 right = chassisPose.ToWorldDirection(Matrix33F.CreateRotationY(wheel.SteeringAngle) * Vector3.UnitX);
    ...
    private float ComputeStopImpulse(Wheel wheel, Vector3 direction)
    {
      ...
      // DigitalRise Physics Documentation (section "Best Practices and Recommended Literature").
