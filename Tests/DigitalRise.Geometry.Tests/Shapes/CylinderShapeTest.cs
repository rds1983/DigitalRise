...
namespace DigitalRise.Geometry.Shapes.Tests
{
  ...
  public class CylinderTest
  {
    ...
    //  Assert.IsTrue(Numeric.AreEqual(MathHelper.ProjectTo(new Vector3(0, 15, 0)+10*new Vector3(1, 0, 1).Normalized(), new Vector3(1, 1, 1)).Length, new CylinderShape(10, 30).GetSupportPointDistance(new Vector3(1, 1, 1))));
    //}
